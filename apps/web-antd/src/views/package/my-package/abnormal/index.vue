...
const [Table, TableApi] = useVbenVxeGrid({
  ...
  gridOptions: {
    ...
    data: [
      {
        abnormalId: 581_700,
        packageId: 121_595_014,
        packageStatus: 4,
        sortingResultId: 110_078_045,
        sortingResultCode: 'FJ1000037029',
        companyId: null,
        companyCode: null,
        companyName: null,
        type: 3,
        words: '录入的重量低于了单件允许的误差重量',
        clientChoice: 0,
        adminHandle: 0,
        interceptPerson: null,
        returnPerson: null,
        sendPerson: null,
        destroyPerson: null,
        packageCode: 'SIX2311111128120',
        trackingNumber: 'test000384',
        predictionWeight: 4,
        sortingWeight: 1.234,
        interceptTime: '2024-09-13 09:14:59',
        organizationId: null,
        othersAbnormalType: null,
        returnReason: null,
